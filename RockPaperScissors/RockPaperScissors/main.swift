...
func verifyValue(of playerInputString: String) {
    guard let playerInputNumber = Int(playerInputString), let cardFromInputNumber = Card.changeNumberToCard(number: playerInputNumber),
          playerInputNumber > 0, playerInputNumber < 4 else {
